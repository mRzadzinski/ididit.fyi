...
import { generateRandomEmail, generateRandomPassword } from '../src/lib/helpers';
...
test('Render login/register elements', async ({ page }) => {
	...
	await expect(page.getByRole('button', { name: 'Login with Google', exact: true })).toBeVisible();
